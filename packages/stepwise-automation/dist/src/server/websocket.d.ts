...
export type WebSocketMessageType = 'run-start' | 'run-end' | 'test-start' | 'test-end' | 'log' | 'error' | 'journeys';
...
export type WSMessage = RunStartMessage | RunEndMessage | TestStartMessage | TestEndMessage | LogMessage | ErrorMessage | JourneysMessage;
/**
