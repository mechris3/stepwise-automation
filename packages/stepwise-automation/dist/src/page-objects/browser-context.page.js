...
exports.BrowserContextPage = void 0;
 ...
 * ```
 */
class BrowserContextPage extends base_page_1.BasePage {
    constructor(adapter) {
        super(adapter);
    }
    /**
     ...
     */
    async selectByText(selector, text, exact) {
        await this.adapter.selectByText(selector, text, exact);
    }
}
exports.BrowserContextPage = BrowserContextPage;
//# sourceMappingURL=browser-context.page.js.map