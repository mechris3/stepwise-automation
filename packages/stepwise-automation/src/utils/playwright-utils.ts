 ...
 */
export async function getText(page: any, selector: string): Promise<string> {
 ...
 */
export async function scrollIntoViewAndClick(page: any, selector: string): Promise<void> {
